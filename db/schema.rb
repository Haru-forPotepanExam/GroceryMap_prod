...
ActiveRecord::Schema.define(version: 2024_07_05_084722) do
  ...
  create_table "favorites", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["google_place_id"], name: "index_favorites_on_google_place_id"
  ...
  create_table "prices", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["google_place_id"], name: "index_prices_on_google_place_id"
  ...
  create_table "stores", primary_key: "google_place_id", id: :string, force: :cascade do |t|
    t.string "name"
    t.string "address"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
